module.exports = function(app, nodemailer){
	app.post('/sendEmail', function(req, res){
	    ...
	    transporter.sendMail({
	        ...
	        subject: 'Verify Email - SharedFi', 
	        html: 'Hello '+emailDetails.name+', <br><br> Please click <a href ="http://localhost/redirect">here</a> to verify your email. <br><br>All the best,<br><br> The SharedFi Team'
	    }, function(err){
	    	if(err && errors == false){
